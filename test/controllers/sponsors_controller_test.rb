...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { logo: @sponsor.logo, name: @sponsor.name, posnr: @sponsor.posnr, visible: @sponsor.visible } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { logo: @sponsor.logo, name: @sponsor.name, posnr: @sponsor.posnr, visible: @sponsor.visible } }
